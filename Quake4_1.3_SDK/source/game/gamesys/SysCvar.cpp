...
idCVar pm_vehicleCameraMinDist(		"pm_vehicleCameraMinDist",		"756",		CVAR_GAME | PC_CVAR_ARCHIVE | CVAR_FLOAT, "" );
idCVar pm_vehicleCameraSpeedScale(	"pm_vehicleCameraSpeedScale",	"0.5",		CVAR_GAME | PC_CVAR_ARCHIVE | CVAR_FLOAT, "" );
idCVar pm_vehicleCameraScaleMax(	"pm_vehicleCameraScaleMax",		"756",		CVAR_GAME | PC_CVAR_ARCHIVE | CVAR_FLOAT, "" );
